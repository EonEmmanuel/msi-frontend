...
function index() {
  ...
  return (
    <div className='font-outfit min-h-screen bg-zinc-950 px-4 py-10'>
      <FontImport />
      ...
      <div className='max-w-7xl mx-auto mb-8'>
        <div className='flex items-center gap-3 mb-2'>
          ...
          <span className='font-anton text-red-500 text-xs tracking-[0.22em] uppercase'>MSI TV</span>
        </div>
        <div className="max-w-3xl">
              <h1 className="fade-up font-anton text-6xl md:text-8xl text-white lg:text-9xl mb-6 leading-none tracking-tight uppercase">
                MSI <span className="text-red-600">LEAGUES</span>
              </h1>
            </div>
      </div>
        ...
        {data.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Logo + name row */}
              <Link to={`/leaguedetail/${item.league_id}`}>
